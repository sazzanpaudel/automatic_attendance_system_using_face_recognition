...
class Student:
    ...
    #Third Image
        ...
        img2 = Image.open("Images/frs.jpg")
        img2 = img2.resize((1530,800),Image.ANTIALIAS)  #Antialias lea high level image lai low level mah convert garxa
        self.photoimg2=ImageTk.PhotoImage(img2)

        f_lbl=Label(self.root,image=self.photoimg2)
        f_lbl.place(x=0, y=0,width=1530,height=900)



        title_lbl=Label(f_lbl,text="STUDENT MANAGEMENT SECTION",font=("times new roman",30,"bold"),bg="white",fg="red")
        title_lbl.place(x=0, y=0, width=1530,height=45)


        main_frame=Frame(f_lbl,bd=2)
        main_frame.place(x=5,y=55,width=1530,height=800)

        # left label frame
        left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("Algerian",12,"bold"))
        left_frame.place(x=10,y=10,width=750,height=700)


     #current course information
        current_course_frame=LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text=" Information",font=("times new roman",12,"bold"))
        current_course_frame.place (x=30,y=105,width=700,height=550)
    ...
    #Year
        ...
        year_label.grid(row=0,column=2,padx=25,sticky=W)
    ...
    #Semester
        ...
        semester_combo["values"]=("Select Semester","Semester-I","Semester-II","Semester-III","SemesterIV","Semester-V","Semester-VI","Semester-VII","Semester-VIII")
        semester_combo.current(0)
        semester_combo.grid(row=1,column=1,padx=2,pady=10,sticky=W)


    #studen ID 
        studentId_label=Label(current_course_frame,text="StudentID:",font=("times new roman",13,"bold"),bg="white")
        studentId_label.grid(row=2,column=0,padx=10,sticky=W)

        studentId_entry=ttk.Entry(current_course_frame,textvariable=self.var_std_id,width=18,font=("times new roman",13,"bold"))
        studentId_entry.grid(row=2,column=1,padx=2,pady=10,sticky=W)
    ...
    #student name
        studentName_label=Label(current_course_frame,text="Student Name:",font=("times new roman",13,"bold"),bg="white")
        studentName_label.grid(row=3,column=0,padx=2,pady=10,sticky=W)

        studentName_entry=ttk.Entry(current_course_frame,textvariable=self.var_std_name,width=18,font=("times new roman",13,"bold"))
        studentName_entry.grid(row=3,column=1,padx=2,pady=10,sticky=W)
    ...
    #Gender
        gender_label=Label(current_course_frame,text="Gender:",font=("times new roman",13,"bold"),bg="white")
        gender_label.grid(row=4,column=0,padx=10,sticky=W)

        gender_combo=ttk.Combobox(current_course_frame,textvariable=self.var_gender,font=("times new roman",13,"bold"),state="readonly",width=16)
        gender_combo["values"]=("Male","Female","Others")
        gender_combo.current(0)
        gender_combo.grid(row=4,column=1,padx=2,pady=10,sticky=W)


    #DOB
        dob_label=Label(current_course_frame,text="DOB:",font=("times new roman",13,"bold"),bg="white")
        dob_label.grid(row=5,column=0,padx=10,sticky=W)

        # dob_entry=ttk.Entry(class_student_frame,textvariable=self.var_dob,width=18,font=("times new roman",13,"bold"))
        # dob_entry.grid(row=2,column=3,padx=10,pady=5,sticky=W)

        cal = DateEntry(current_course_frame,textvariable=self.var_dob, width=23, year=2019, month=6, day=22, 
         background='darkblue', foreground='white', borderwidth=2)
        cal.grid(row=5,column=1,padx=2, pady=10,sticky=W)
    ...
    #Email
        email_label=Label(current_course_frame,text="Email:",font=("times new roman",13,"bold"),bg="white")
        email_label.grid(row=6,column=0,padx=10,sticky=W)

        email_entry=ttk.Entry(current_course_frame,textvariable=self.var_email,width=18,font=("times new roman",13,"bold"))
        email_entry.grid(row=6,column=1,padx=2,pady=10,sticky=W)



        email=Label(current_course_frame,text="*ex123@gmail.com",font=("times new roman",6,"bold"),fg="red",bg="white")
        # pswd.grid(row=8,column=1,padx=5,pady=5,sticky=W)
        email.place(x=129, y=298)
    ...
    #Phone no
        phone_label=Label(current_course_frame,text="Phone No:",font=("times new roman",13,"bold"),bg="white")
        phone_label.grid(row=7,column=0,padx=10,sticky=W)

        phone_entry=ttk.Entry(current_course_frame,textvariable=self.var_phone,width=18,font=("times new roman",13,"bold"))
    ...
    #Address
        address_label=Label(current_course_frame,text="Address:",font=("times new roman",13,"bold"),bg="white")
        address_label.grid(row=8,column=0,padx=10,sticky=W)

        address_entry=ttk.Entry(current_course_frame,textvariable=self.var_address,width=18,font=("times new roman",13,"bold"))
        address_entry.grid(row=8,column=1,padx=2,pady=10,sticky=W)
    ...
    #radio buttons
        ...
        radiobtn1=ttk.Radiobutton(current_course_frame,variable=self.var_radio1,text="Take Photo Sample",value="Yes")
        radiobtn1.grid(row=9,column=0)

        radiobtn2=ttk.Radiobutton(current_course_frame,variable=self.var_radio1,text="No Photo Sample",value="NO")
        radiobtn2.grid(row=9,column=1)

    #button frame
        btn_frame=Frame(current_course_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame.place(x=0,y=425,width=696,height=35)
    ...
    #frame for take photo and update photo
        ...
        btn_frame1.place(x=0,y=470,width=696,height=35)

        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=70,font=("times new roman",13,"bold"),bg="blue",fg="white")
...
#Table frame
        ...
        table_frame.place(x=5,y=150,width=700,height=500)
...
#scroll bar 
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","year","sem","id","name","gender","dob","email","phone","address","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        if len(id) <=6:
          ...
          if len(str(id))==0:
            return True
              ...
              messagebox.showerror('Invalid','Invalid entry ID. Please enter ID as integer value')
              return False
        else:
...
####function decleration ######
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            messagebox.showerror("Error",'Invalid email Enter valid email like sajjan123@gmail.com ',parent=self.root)
        else:
            try:
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    ...
                    # conn=mysql.connector.connect(host="localhost",username="root",password="Keshav@123",database="mydata")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,Year=%s,Semester=%s,Name=%s,Gender=%s,Dob=%s,Email=%s,PhoneNumber=%s,Address=%s,PhotoSample=%s where Student_id=%s",(
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #s_name=my_cursor.execute("select Name from student where Student_id=%s")
                ...
                img_id=0
                USER_INP = simpledialog.askstring(title="Detail", prompt="Enter Roll number/ID:")
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_name_path="mydata/"+"user"+"."+str(USER_INP)+"."+str(img_id)+".jpg"

...
class Attendance:
    def __init__(self,root):
        ...
        # second image
        img1=Image.open(r"Images\frs.jpg")
        ...
        title_lbl=Label(f_lbl,text="ATTENDANCE MANAGE SECTION",font=("times new roman",18,"bold"),bg="blue",fg="white")
        ...
        img_left=Image.open(r"Images\SD.jpg")
        ...
        attendanceID_entry.grid(row=0,column=1,padx=8,pady=4,sticky=W)
        ...
        save_button=Button(btn_frame,text="Import csv",command=self.importCsv,width=17,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        update_button=Button(btn_frame,text="View Attendance Report ",command=self.viewReport,width=18,font=("times new roman",12,"bold"),bg="blue",fg="white")
        update_button.grid(row=0,column=1)
        
        delete_button=Button(btn_frame,text="Update",width=17,command=self.action,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        Right_frame.place(x=770,y=10,width=710,height=700)
        ...
        self.AttendanceReportTable=ttk.Treeview(table_frame,columns=("Studentid","name","department","time","date","attendance"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def action(self):
        ...
        try:
            ...
            with open(fln,mode="a",newline="\n") as f:
                dict_writer=csv.DictWriter(f,fieldnames=(["Studentid","Name","Department","Time","Date","Attendance"]))
